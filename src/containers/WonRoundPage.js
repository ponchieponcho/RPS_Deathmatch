      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 76 90.22">
        ...
        <g id="youwonid1" data-name="Layer 2">
            <g id="youwonid2" data-name="Objects">
                ...
                <path d="M67.67,37.92A29.67,29.67,0,1,1,38,8.25,29.67,29.67,0,0,1,67.67,37.92Z" fill="#39b5ac" stroke="#f1f2f2" stroke-width="2"/>
                <path d="M64.58,37.92A26.58,26.58,0,1,1,38,11.34,26.59,26.59,0,0,1,64.58,37.92Z" fill="none" stroke="#f1f2f2" stroke-linecap="round" stroke-dasharray="2 3"/>
                <path d="M30.69,27.84a3,3,0,1,1-3-3A3,3,0,0,1,30.69,27.84Z" fill="#fff" stroke="#f1f2f2" stroke-width="2"/>
                <path d="M49.56,27.65a3,3,0,1,1-3-3A3,3,0,0,1,49.56,27.65Z" fill="#fff" stroke="#f1f2f2" stroke-width="2"/>
                <path d="M48.63,44.1c-5.69,6.56-13,11.75-22,0" fill="none" stroke="#f1f2f2" stroke-linecap="round" stroke-width="2"/>
            </g>
        </g>
      </svg>
      </div>
